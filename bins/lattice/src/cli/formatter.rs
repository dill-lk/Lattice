...
pub fn print_transaction_card(
    ...
    println!("  {}    {}", "From".dimmed(), format_address(from));
    println!("  {}      {}", "To".dimmed(), format_address(to));
...
pub fn print_wallet_card(address: &Address, balance: Amount, nonce: u64) {
    println!();
    println!("  {}", "Wallet Details".bold().cyan());
    println!("  {}", "─".repeat(50).dimmed());
...
pub fn print_block_card(
    ...
    println!();
    println!("  {} {}", "Block Details".bold().cyan(), format!("#{}", format_height(height)).yellow());
    println!("  {}", "─".repeat(50).dimmed());
    println!("  {}   {}", "Hash".dimmed(), format_hash(hash).white());
    println!("  {}   {}", "Time".dimmed(), timestamp.to_string().dimmed());
    println!("  {}    {}", "Txs".dimmed(), tx_count.to_string().white());
    println!("  {}  {}", "Miner".dimmed(), format_address(miner));
    println!();
}
...
pub fn print_banner() {
    ...
    println!(
        "  {}  {}",
        "LATTICE ALL-IN-ONE CLI".bold().cyan(),
        "v0.1.0".dimmed()
    );
    println!("  {}", "Quantum-Resistant Blockchain Platform".dimmed());
    println!();
}
