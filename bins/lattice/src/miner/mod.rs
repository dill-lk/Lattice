//! Lattice Miner - Standalone mining application module
//!
...
pub async fn run_miner(args: MinerArgs, rpc_url: &str) -> Result<()> {
    ...
    let event_tx = {
        let (tx, rx) = mpsc::channel::<MinerEvent>(64);
        // Display loop: owns all stdout output after the banner.
        let display_stats = MiningStats::new();
        let display_height = Arc::new(AtomicU64::new(0));
